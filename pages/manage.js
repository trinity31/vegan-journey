  ...
  return (
    <Container>
      ...
      >
        ...
        <button className="bg-pink-400 rounded-lg py-4 px-8 text-white text-xl block focus:outline-none focus:ring-pink-500 focus:ring-offset-2 transform hover:scale-105 active:scale-95 transition-all duration-100 ease-in-out">
          Translate
        </button>
      </div>
      <div
